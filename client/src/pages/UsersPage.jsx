...
export default function UsersPage() {
  ...
  async function resetPasswordByAdmin(user) {
    const newPassword = window.prompt(`Set password baru untuk ${user.full_name} (min 8 karakter):`);
